...
This section is a short guide explaining how to develop new option
kinds for =clingon=. The new option, which we'll develop will be used
for specifying email addresses.
